...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-bold text-gray-900 dark:text-dark-text">Add Bulk Data</h1>
        <a href="<?= url('students', 'sample-csv') ?>"
           class="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-dark-border text-sm rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:bg-dark-bg font-medium">
    ...
    <div class="bg-white dark:bg-dark-card rounded-xl border border-gray-200 dark:border-dark-border p-6">
        <form method="POST" action="<?= url('students', 'bulk-import') ?>" enctype="multipart/form-data" id="importForm">
            ...
            <!-- File drop zone -->
            <div class="border-2 border-dashed border-gray-300 dark:border-dark-border rounded-xl p-10 text-center mb-6 hover:border-primary-400 transition-colors"
                 id="dropZone"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">On Duplicate Admission No.</label>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-xs">
                <thead class="bg-gray-50 dark:bg-dark-bg border-b border-gray-200 dark:border-dark-border">
                    <tr>
                        <th class="px-4 py-2 text-left font-medium text-gray-700 dark:text-gray-300">Column Name</th>
                        <th class="px-4 py-2 text-left font-medium text-gray-700 dark:text-gray-300">Required</th>
                        <th class="px-4 py-2 text-left font-medium text-gray-700 dark:text-gray-300">Example</th>
                        <th class="px-4 py-2 text-left font-medium text-gray-700 dark:text-gray-300">Notes</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100 dark:divide-dark-border">
                    ...
                    <tr class="hover:bg-gray-50 dark:bg-dark-bg">
                        <td class="px-4 py-2 font-mono text-gray-800 dark:text-dark-text"><?= $col ?></td>
                        <td class="px-4 py-2">
                            <?php if ($req): ?>
                        ...
                        <td class="px-4 py-2 font-mono text-gray-500 dark:text-dark-muted"><?= e($ex) ?></td>
                        <td class="px-4 py-2 text-gray-500 dark:text-dark-muted"><?= e($note) ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
