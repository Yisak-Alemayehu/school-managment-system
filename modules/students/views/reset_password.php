...
<div class="max-w-2xl mx-auto space-y-6">
    <h1 class="text-xl font-bold text-gray-900 dark:text-dark-text">Reset Student Password</h1>
    ...
    <div class="bg-white dark:bg-dark-card rounded-xl border border-gray-200 dark:border-dark-border p-6">
        <h2 class="text-sm font-semibold text-gray-900 dark:text-dark-text mb-4 pb-2 border-b">Reset Individual Student Password</h2>
