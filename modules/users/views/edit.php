...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl font-bold text-gray-900 dark:text-dark-text">Edit User: <?= e($userRecord['full_name']) ?></h1>
    </div>
    ...
    <div class="bg-white dark:bg-dark-card rounded-xl border border-gray-200 dark:border-dark-border p-6">
        <form method="POST" action="<?= url('users', 'edit', $id) ?>" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" value="<?= e($userRecord['username']) ?>" disabled
                           class="w-full px-3 py-2 border border-gray-200 dark:border-dark-border bg-gray-50 dark:bg-dark-bg rounded-lg text-sm text-gray-500 dark:text-dark-muted">
                </div>
            ...
            <div class="pt-4 border-t">
                <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Change Password <span class="text-xs text-gray-400 dark:text-gray-500">(leave blank to keep current)</span></p>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t">
                <a href="<?= url('users') ?>" class="px-4 py-2 border border-gray-300 dark:border-dark-border rounded-lg text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:bg-dark-bg">Cancel</a>
