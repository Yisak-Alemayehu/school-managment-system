...
<div class="space-y-4">
    <h1 class="text-xl font-bold text-gray-900">Penalty Report</h1>
    ...
    <form method="POST" action="<?= url('finance', 'report-generate') ?>">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                    <h3 class="text-xs font-semibold text-gray-500 uppercase mb-2">Student Info</h3>
                    <div class="space-y-2">
                ...
                <div>
                    <h3 class="text-xs font-semibold text-gray-500 uppercase mb-2">Fee Info</h3>
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center gap-2 text-sm"><input type="checkbox" name="fields[]" value="balance" checked class="rounded border-gray-300 text-primary-600"> Outstanding Balance</label>
                    </div>
                </div>
                <div>
                    <h3 class="text-xs font-semibold text-gray-500 uppercase mb-2">Penalty Info</h3>
                    <div class="space-y-2">
                        <label class="flex items-center gap-2 text-sm"><input type="checkbox" name="fields[]" value="penalty_count" checked class="rounded border-gray-300 text-primary-600"> Penalty Count</label>
                        <label class="flex items-center gap-2 text-sm"><input type="checkbox" name="fields[]" value="penalty_total" checked class="rounded border-gray-300 text-primary-600"> Total Penalty Amount</label>
                        <label class="flex items-center gap-2 text-sm"><input type="checkbox" name="fields[]" value="last_penalty_date" class="rounded border-gray-300 text-primary-600"> Last Penalty Date</label>
                        <label class="flex items-center gap-2 text-sm"><input type="checkbox" name="fields[]" value="penalty_type" class="rounded border-gray-300 text-primary-600"> Penalty Type</label>
                    </div>
                </div>
            </div>
        </div>
