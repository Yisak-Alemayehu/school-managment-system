...
<div class="space-y-4">
    <div class="flex items-center justify-between flex-wrap gap-2">
        <h1 class="text-xl font-bold text-gray-900">Supplementary Fee Payment History</h1>
    ...
    <!-- Filters -->
    <form method="GET" action="<?= url('finance', 'supplementary-payments') ?>" class="bg-white rounded-xl border border-gray-200 p-4">
        <div class="flex flex-wrap gap-3">
            ...
            <select name="sfee_id" class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500">
            ...
            <a href="<?= url('finance', 'supplementary-payments') ?>" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm hover:bg-gray-200 font-medium">Clear</a>
        </div>
    </form>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 responsive-table">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if (empty($rows)): ?>
                    <tr><td colspan="9" class="px-4 py-8 text-center text-gray-400">No supplementary payment records found.</td></tr>
                    <?php else: ?>
