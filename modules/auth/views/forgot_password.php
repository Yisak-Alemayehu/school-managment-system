...
<body class="bg-gray-100 dark:bg-dark-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-dark-text"><?= __('forgot_password') ?></h1>
            <p class="text-gray-500 dark:text-dark-muted mt-1"><?= __('forgot_password_text') ?></p>
        </div>

        <?php if ($flash = get_flash('success')): ?>
            <div class="mb-4 p-3 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-lg text-sm"><?= e($flash) ?></div>
        <?php endif; ?>
