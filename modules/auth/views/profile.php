...
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-dark-card rounded-xl shadow-sm border border-gray-200 dark:border-dark-border p-6">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-dark-muted"><?= e($user['role_name'] ?? 'User') ?></p>
            </div>
        </div>
    ...
    <!-- Account Info -->
    <div class="mt-6 bg-white dark:bg-dark-card rounded-xl shadow-sm border border-gray-200 dark:border-dark-border p-6">
        <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Account Information</h3>
        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
                <dt class="text-gray-500 dark:text-dark-muted">Member Since</dt>
                <dd class="font-medium text-gray-900 dark:text-dark-text"><?= format_date($userRecord['created_at']) ?></dd>
            </div>
            <div>
