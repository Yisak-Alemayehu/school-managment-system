...
<body class="bg-gray-50 dark:bg-dark-bg flex items-center justify-center min-h-screen p-4 transition-colors">
    <div class="text-center max-w-md">
        ...
        <h1 class="text-2xl font-bold text-gray-800 dark:text-dark-text mb-2">Page Not Found</h1>
        <p class="text-gray-600 dark:text-dark-muted mb-6">The page you're looking for doesn't exist or has been moved.</p>
