...
$mobileNav = [
    ...
    ['icon' => 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z', 'label' => 'Messages', 'url' => '/messaging/inbox', 'module' => 'messaging'],
    ...
    <div class="flex items-center justify-around h-14">
        ...
        <a href="<?= $item['url'] === '#' ? '#' : url($item['url']) ?>" <?= $onclick ?> class="relative flex flex-col items-center justify-center gap-0.5 w-full h-full <?= $activeClass ?>">
            ...
            <?php if ($item['module'] === 'messaging'):
                ...
                if ($mobileUnread > 0): ?>
            <span id="mobile-msg-badge" class="absolute top-0.5 right-1/4 bg-red-500 text-white text-[8px] font-bold w-4 h-4 flex items-center justify-center rounded-full"><?= $mobileUnread > 9 ? '9+' : $mobileUnread ?></span>
            <?php endif; endif; ?>
        </a>
        <?php endforeach; ?>
    </div>
